      ...
      <ul className="dropdown-menu">
        ...
        <li>
          ...
          <ul className="dropdown-menu__submenu">
            <li>
              <img src={CalypsoRed} width="12rem" />
              <Link to={"/items/orchestral-strings#violin"}>{t("violin")}</Link>
              <ul className="instruments">
                {violin.map((item) => {
                  return <ItemList item={item} />;
                })}
        ...
        <li>
          ...
          <ul className="dropdown-menu__submenu">
            <li>
              <img src={CalypsoRed} width="12rem" />
              <Link to={"/items/brass-wind#brass-wind"}>{t("brass-wind")}</Link>
              <ul className="instruments">
                {brass.map((item) => {
                  return <ItemList item={item} />;
                })}
        ...
        <li>
          ...
          <ul className="dropdown-menu__submenu">
            <li>
              <img src={CalypsoRed} width="12rem" />
              <Link to={"/items/drums-percussion#drumset"}>{t("drumset")}</Link>
              <ul className="instruments">
                {drumset.map((item) => {
                  return <ItemList item={item} />;
                })}
